...
Set-Location $repo
node scripts/meeting.mjs "council/voice-coldsynth-question.txt" --out "council/voice-coldsynth-answers.json" 2>&1 | Tee-Object -FilePath "council/voice-coldsynth-log.txt"
