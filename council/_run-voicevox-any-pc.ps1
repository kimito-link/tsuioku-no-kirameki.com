...
Set-Location $repo
node scripts/meeting.mjs "council/voicevox-any-pc-question.txt" --out "council/voicevox-any-pc-answers.json" 2>&1 | Tee-Object -FilePath "council/voicevox-any-pc-log.txt"
