...
Set-Location $repo
node scripts/meeting.mjs "council/tanu-lane-heavy-stall-question.txt" --out "council/tanu-lane-heavy-stall-answers.json" 2>&1 | Tee-Object -FilePath "council/tanu-lane-heavy-stall-log.txt"
