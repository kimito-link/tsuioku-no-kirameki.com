...
Set-Location $repo
node scripts/meeting.mjs "council/venue-grid-diag-question.txt" --out "council/venue-grid-diag-answers.json" 2>&1 | Tee-Object -FilePath "council/venue-grid-diag-log.txt"
