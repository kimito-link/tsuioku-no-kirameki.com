...
Set-Location $repo
node scripts/meeting.mjs "council/why-fixes-dont-stick-question.txt" --out "council/why-fixes-dont-stick-answers.json" 2>&1 | Tee-Object -FilePath "council/why-fixes-dont-stick-log.txt"
