...
Set-Location $repo
node scripts/meeting.mjs "council/venue-role-separation-question.txt" --out "council/venue-role-separation-answers.json" 2>&1 | Tee-Object -FilePath "council/venue-role-separation-log.txt"
