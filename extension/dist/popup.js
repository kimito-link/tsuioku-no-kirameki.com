...
\u203B\u3046\u307E\u304F\u3044\u304B\u306A\u3044\u3068\u304D: ${hintLines.join("\n")}` : s;
  ...
  async function refresh() {
    ...
    try {
      ...
      const radioViewportWideOff = (
        /** @type {HTMLInputElement|null} */
        $("inlinePanelViewportWideOff")
      );
      const radioViewportWideAlways = (
        /** @type {HTMLInputElement|null} */
        $("inlinePanelViewportWideAlways")
      );
      const radioViewportWideOnce = (
        /** @type {HTMLInputElement|null} */
        $("inlinePanelViewportWideOnce")
      );
      if (radioViewportWideOff && radioViewportWideAlways && radioViewportWideOnce) {
        radioViewportWideOff.checked = viewportWidePolicy === INLINE_PANEL_VIEWPORT_WIDE_OFF;
        radioViewportWideAlways.checked = viewportWidePolicy === INLINE_PANEL_VIEWPORT_WIDE_ALWAYS;
        radioViewportWideOnce.checked = viewportWidePolicy === INLINE_PANEL_VIEWPORT_WIDE_ONCE;
      }
...
<html lang="ja">
  ...
  function paintVersionBadge() {
    ...
    try {
      ...
      const buildId = "0504-1212" ? String("0504-1212") : "dev";
  ...
  function initPopup() {
    ...
    const saveInlinePanelViewportWidePolicy = async (value) => {
      const v = value === INLINE_PANEL_VIEWPORT_WIDE_ALWAYS ? INLINE_PANEL_VIEWPORT_WIDE_ALWAYS : value === INLINE_PANEL_VIEWPORT_WIDE_ONCE ? INLINE_PANEL_VIEWPORT_WIDE_ONCE : INLINE_PANEL_VIEWPORT_WIDE_OFF;
      const patch = {
