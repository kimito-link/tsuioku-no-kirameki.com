...
graph LR
  ...
  HUB --> f18["ちくらん風 配信カード(サムネ+来場+コメント+ギフト)"]
  f18 --> f18_0["lib/chikuranCard.js"]
  f18 --> f18_1["extension/status-entry.js"]
  f18 --> f18_2["extension/content-entry.js"]
  HUB --> f19["応援者ランキング(ちくらん風・将来の Kimito Link ランキング)"]
  f19 --> f19_0["lib/supporterRanking.js"]
  f19 --> f19_1["lib/reportPreview.js"]
  f19 --> f19_2["extension/status-entry.js"]
  HUB --> f20["状態→放送の導線(配信カードから watch へ)"]
  f20 --> f20_0["lib/watchLink.js"]
  f20 --> f20_1["extension/status-entry.js"]
  HUB --> f21["数字の自己矛盾の自動検知(self-verifying)"]
  f21 --> f21_0["lib/numberConsistency.js"]
  f21 --> f21_1["lib/statusActionAdvisor.js"]
  HUB --> f22["診断の信頼度メーター(数値の意味注釈)"]
  f22 --> f22_0["lib/metricConfidence.js"]
  f22 --> f22_1["lib/reportPreview.js"]
  f22 --> f22_2["extension/status-entry.js"]
  HUB --> f23["時系列トレンド(スナップショットで見えない劣化検知)"]
  f23 --> f23_0["lib/statusTrend.js"]
  f23 --> f23_1["lib/statusTrendKey.js"]
  f23 --> f23_2["extension/status-entry.js"]
  f23 --> f23_3["lib/statusActionAdvisor.js"]
  HUB --> f24["状態速報の整形"]
  f24 --> f24_0["lib/statusFormat.js"]
  HUB --> f25["記録件数の単調化(減らない表示)"]
  f25 --> f25_0["lib/monotonicCommentCount.js"]
  HUB --> f26["storage キー定義"]
  f26 --> f26_0["lib/storageKeys.js"]
  HUB --> f27["AI診断の状態速報集約"]
  f27 --> f27_0["lib/aiSharePopupDiagKey.js"]
  f27 --> f27_1["extension/status-entry.js"]
  HUB --> f28["状態速報の全体マインドマップ"]
  f28 --> f28_0["lib/statusMindmapModel.js"]
  f28 --> f28_1["extension/status-entry.js"]
  HUB --> f29["状態速報の対処カード(症状→原因→次の一手)"]
  f29 --> f29_0["lib/statusActionAdvisor.js"]
  f29 --> f29_1["extension/status-entry.js"]
  HUB --> f30["サイト健全性検証(リンク切れ防止)"]
  f30 --> f30_0["lib/siteLinkHealth.js"]
  f30 --> f30_1["site-health.mjs"]
  HUB --> f31["影響範囲マップ(変えたら何が壊れるか)"]
  f31 --> f31_0["feature-map.mjs"]
  f31 --> f31_1["feature-map/impact-map.md"]
  HUB --> f32["全体マップ(全地図への入口)"]
  f32 --> f32_0["MAP.md"]
  HUB --> f33["影響範囲ゲート(規律を自動化)"]
  f33 --> f33_0["impact-check.mjs"]
  f33 --> f33_1["feature-map/impact-map.json"]
```
...
- `lib/`（919 件） — 純粋関数ライブラリ(unit test 対象)。色・速度・コメント・レポート等の計算ロジックの大半  〔色 / 速度 / コメント / レポート / 純粋関数〕
...
- `src/lib/chikuranCard.js` ⚠️ **見つからない（消失/リネーム）**
- [`src/extension/status-entry.js`](../src/extension/status-entry.js)
