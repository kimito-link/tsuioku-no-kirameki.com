...
graph LR
  ...
  HUB --> f18["診断/ちくらん タブ+カードクリックで応援者展開"]
  f18 --> f18_0["extension/status-entry.js"]
  f18 --> f18_1["status.html"]
  f18 --> f18_2["lib/supporterRanking.js"]
  HUB --> f19["ちくらん風 配信カード(サムネ+来場+コメント+ギフト)"]
  f19 --> f19_0["lib/chikuranCard.js"]
  f19 --> f19_1["extension/status-entry.js"]
  f19 --> f19_2["extension/content-entry.js"]
  HUB --> f20["応援者ランキング(ちくらん風・将来の Kimito Link ランキング)"]
  f20 --> f20_0["lib/supporterRanking.js"]
  f20 --> f20_1["lib/reportPreview.js"]
  f20 --> f20_2["extension/status-entry.js"]
  HUB --> f21["状態→放送の導線(配信カードから watch へ)"]
  f21 --> f21_0["lib/watchLink.js"]
  f21 --> f21_1["extension/status-entry.js"]
  HUB --> f22["数字の自己矛盾の自動検知(self-verifying)"]
  f22 --> f22_0["lib/numberConsistency.js"]
  f22 --> f22_1["lib/statusActionAdvisor.js"]
  HUB --> f23["診断の信頼度メーター(数値の意味注釈)"]
  f23 --> f23_0["lib/metricConfidence.js"]
  f23 --> f23_1["lib/reportPreview.js"]
  f23 --> f23_2["extension/status-entry.js"]
  HUB --> f24["時系列トレンド(スナップショットで見えない劣化検知)"]
  f24 --> f24_0["lib/statusTrend.js"]
  f24 --> f24_1["lib/statusTrendKey.js"]
  f24 --> f24_2["extension/status-entry.js"]
  f24 --> f24_3["lib/statusActionAdvisor.js"]
  HUB --> f25["状態速報の整形"]
  f25 --> f25_0["lib/statusFormat.js"]
  HUB --> f26["記録件数の単調化(減らない表示)"]
  f26 --> f26_0["lib/monotonicCommentCount.js"]
  HUB --> f27["storage キー定義"]
  f27 --> f27_0["lib/storageKeys.js"]
  HUB --> f28["AI診断の状態速報集約"]
  f28 --> f28_0["lib/aiSharePopupDiagKey.js"]
  f28 --> f28_1["extension/status-entry.js"]
  HUB --> f29["状態速報の全体マインドマップ"]
  f29 --> f29_0["lib/statusMindmapModel.js"]
  f29 --> f29_1["extension/status-entry.js"]
  HUB --> f30["状態速報の対処カード(症状→原因→次の一手)"]
  f30 --> f30_0["lib/statusActionAdvisor.js"]
  f30 --> f30_1["extension/status-entry.js"]
  HUB --> f31["サイト健全性検証(リンク切れ防止)"]
  f31 --> f31_0["lib/siteLinkHealth.js"]
  f31 --> f31_1["site-health.mjs"]
  HUB --> f32["影響範囲マップ(変えたら何が壊れるか)"]
  f32 --> f32_0["feature-map.mjs"]
  f32 --> f32_1["feature-map/impact-map.md"]
  HUB --> f33["全体マップ(全地図への入口)"]
  f33 --> f33_0["MAP.md"]
  HUB --> f34["影響範囲ゲート(規律を自動化)"]
  f34 --> f34_0["impact-check.mjs"]
  f34 --> f34_1["feature-map/impact-map.json"]
```
...
- `lib/`（921 件） — 純粋関数ライブラリ(unit test 対象)。色・速度・コメント・レポート等の計算ロジックの大半  〔色 / 速度 / コメント / レポート / 純粋関数〕
