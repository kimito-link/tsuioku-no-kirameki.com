...
- 読むキー: `KEY_BGM_ENABLED`, `KEY_BGM_VOLUME_FEVER`, `KEY_BGM_VOLUME_REACH`, `KEY_EFFECT_SOUND_ENABLED`, `KEY_HIGHLIGHT_LEDGER`, `KEY_LANE_MIRROR`, `KEY_LIVE_BROADCASTER_CTX`, `KEY_STORY_DIAG_MIRROR`, `KEY_USER_COMMENT_PROFILE_CACHE`
...
graph LR
  ...
  n_venue --> n_src_lib_laneMirrorContract_js["lib/laneMirrorContract.js"]:::shared
  classDef shared fill:#eee,stroke:#999,color:#666;
```

> ほか 89 ファイル省略（全件は storage-bus.md / metafile 参照）。
