...
graph LR
  ...
  n_venue --> n_src_extension_story_laneContentLod_js["extension/story/laneContentLod.js"]:::shared
  ...
  n_venue --> n_src_lib_anomalyVerdict_js["lib/anomalyVerdict.js"]:::shared
...
> ほか 101 ファイル省略（全件は storage-bus.md / metafile 参照）。
