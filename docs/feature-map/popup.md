...
- 書くキー: `KEY_BACKFILL_ENABLED`, `KEY_BACKFILL_PROGRESS`, `KEY_BGM_PHASE_DIAG`, `KEY_CHEER_RECENT_V1`, `KEY_COMMENTER_FOLLOW_CACHE`, `KEY_COMMENT_INGEST_LOG`, `KEY_CONCURRENT_CALIBRATION_RING_V1`, `KEY_GIFT_RANKING_LANE_ENABLED`, `KEY_LANE_DIAG`, `KEY_MILESTONE_EFFECT_DIAG`, `KEY_PAINT_PERF_RING_V1`, `KEY_POPUP_FRAME`, `KEY_POPUP_FRAME_CUSTOM`, `KEY_PREVIEW_RENDER_ACK`, `KEY_REPORT_PREVIEW`, `KEY_STORAGE_WRITE_ERROR`, `KEY_VOICE_EFFECT_DIAG`, `KEY_VOICE_INPUT_DEVICE`, `fn:perfDiagStorageKey`
...
> ほか 299 ファイル省略（全件は storage-bus.md / metafile 参照）。
