...
- `src/lib/anomalyVerdict.js` → **3 機能**: ポップアップ(応援レーン) / 状態速報ページ / Web版 状態(スマホ)
...
| `src/lib/anomalyVerdict.js` | 3 | ポップアップ(応援レーン) / 状態速報ページ / Web版 状態(スマホ) |
...
| `src/lib/venueMirrorIntakeDiag.js` | 2 | 記録エンジン(watchページ常駐) / 会場モード(standalone) |
