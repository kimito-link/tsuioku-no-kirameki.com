...
<details><summary>🗂 このカテゴリの全担当ファイル(自動分類) 75</summary>
...
> changelog 全 770 版を「バグ系統」で束ねた枝。同系統をまた触るとき、過去の修正と「なぜ毎回触るか」を辿る(再発防止)。新しい順。
...
- `v0.1.1378` 2026-08-12 — サムネ・ID・名前がどれだけ取れているか出すように
- `v0.1.1376` 2026-08-12 — たぬ姉段がぎっしり並んで見にくいのを改善
...
- `v0.1.1396` 2026-08-15 — 「会場座席」の誤った警告と、描き直し回数の紛らわしい表示を直しました
- `v0.1.1395` 2026-08-14 — 追加した診断項目が実際に表示されるようにしました
...
### 🪟 応援レーン・タイル (184版)
- `v0.1.1430` 2026-08-18 — 広告メッセージが分かるようになりました
- `v0.1.1428` 2026-08-18 — 応援レーンの軽量化が効いているか見えるようにしました
- `v0.1.1427` 2026-08-18 — サイドパネルで応援レーンが出ないのを修正
- `v0.1.1426` 2026-08-18 — 応援レーンの動作を軽くしました
...
- `v0.1.1380` 2026-08-12 — 応援レーンのタイルが58人から17人に減る問題を修正
- `v0.1.1378` 2026-08-12 — サムネ・ID・名前がどれだけ取れているか出すように
- `v0.1.1370` 2026-08-12 — 応援レーンのタイルが急に減る問題の根治と、状態速報の数字の是正
- `v0.1.1367` 2026-08-12 — 応援レーンが途中件数で止まる問題の根治（78件中19件しか出ない）
- `v0.1.1363` 2026-08-12 — fix(lane): 応援レーンが全員そろわないのを直す
...
- `v0.1.1414` 2026-08-16 — サイドパネルの黒さと、前版で増えた書き込みを修正
- `v0.1.1413` 2026-08-16 — 診断・会場・コメビュが黒くなるのを修正
- `v0.1.1410` 2026-08-16 — 診断ページが開くまでの待ち時間を短縮
- `v0.1.1409` 2026-08-16 — 診断タブが重すぎて開かない問題を修正
- `v0.1.1408` 2026-08-16 — 診断項目が100個になりました（19の枠に分類）
- `v0.1.1407` 2026-08-16 — 診断を74→85項目に。読み上げと公式値の原因を分離
- `v0.1.1406` 2026-08-15 — 診断を63→74項目に増やし、レーンを3枠に分けました
- `v0.1.1405` 2026-08-15 — 会場の鏡が古いままになる原因を名指しします
...
- `v0.1.1401` 2026-08-15 — 診断画面を固定テーブルにしました（項目が消えて位置がずれる問題の解消）
- `v0.1.1400` 2026-08-15 — 診断項目を40→54に増やし、枠も14に増やしました
- `v0.1.1399` 2026-08-15 — 診断項目を増やす前の土台（登録した項目が必ず表示される保証）を追加
- `v0.1.1398` 2026-08-15 — 黒画面の計測が機能していなかったのを修正 + 診断の枠を13個に細分化
- `v0.1.1395` 2026-08-14 — 追加した診断項目が実際に表示されるようにしました
- `v0.1.1386` 2026-08-13 — アイコンが白いままになる問題を改善
- `v0.1.1385` 2026-08-13 — 症状ごとの判定を出すようにしました
- `v0.1.1384` 2026-08-13 — 更新のたびの手作業（リロード・F5）を減らします
- `v0.1.1383` 2026-08-13 — 診断が「3時間半フリーズ」と誤表示する問題を修正
...
### その他 (99版)
- `v0.1.1440` 2026-08-19 — 引っ張るときの黒さに対処
...
- `v0.1.1418` 2026-08-17 — パネルを開いた時の暗い時間を短縮
