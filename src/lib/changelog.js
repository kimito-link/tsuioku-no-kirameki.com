...
export const EXTENSION_CHANGELOG = Object.freeze([
  ...
  Object.freeze({
    ...
    items: Object.freeze([
      ...
      '過去コメントをたくさん取り込む間にページが「応答しません」と固まりやすくなることがある問題も改善しました。取り込みの途中でこまめに画面に処理を譲り、まとめて保存するようにして、ページが固まりにくくしています',
      '配信の途中から開いたとき、過去をさかのぼる入口がまだ見つからずほとんど取り込めないことがありました。これまでは手動で「もう一度」を押す必要がありましたが、少し待って自動でやり直すようにしたので、開いてしばらくすると勝手に取り込みが進みます'
    ])
  }),
  Object.freeze({
    version: '0.1.430',
    ...
    items: Object.freeze([
      '途中から開いた配信で、過去コメントの取り込みが途中で止まってしまう問題を改善しました（これまでは「もう一度押す」と続きが取れていました）。さかのぼる途中でつまずいたり手掛かりが見つからないときも、もっと前から何度か探し直して、配信のはじめまで取り続けるようにしました'
    ])
  }),
  Object.freeze({
    version: '0.1.424',
