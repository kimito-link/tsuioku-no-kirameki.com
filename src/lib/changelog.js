...
export const EXTENSION_CHANGELOG = Object.freeze([
  Object.freeze({
    version: '0.1.360',
    date: '2026-05-25',
    summary: '同じ瞬間の同じ短文コメントが1件に消える不具合を修正',
    items: Object.freeze([
      '[修正] 別々の人がほぼ同時刻に同じ短いコメント（「8888」「草」「おつ」など）を送ったとき、コメント番号が付かない経路で記録すると1件にまとめられてしまい、片方が消えたり名前が取り違わったりすることがある不具合を直しました。同じ瞬間でも投稿者が違えば別々のコメントとして記録します（コメント番号が付く通常の記録はこれまでどおりで、同じ人の重複は引き続き1件にまとめます）'
    ])
  }),
  Object.freeze({
    version: '0.1.355',
