 ...
 *   SC2(2026-07-06)で追加された highlightLedger(KEY_HIGHLIGHT_LEDGER)、
 *   SC3(council/broadcast-scoring-SYNTHESIS.md §2.1)で追加された
 *   scoreAnnounceDiag(KEY_SCORE_ANNOUNCE_DIAG)も含む。
